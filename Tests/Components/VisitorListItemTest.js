...
import VisitorListItem from '../../App/Components/VisitorListItem'

const wrapper = shallow(<VisitorListItem />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('VisitorListItem Component')) // That the Component Text is included
})
